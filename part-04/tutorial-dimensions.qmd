...
# Small Exercises on working with iterables

```{python}
# a) TODO: Calculate distances in 2 dimensions
...
# - Create a list of 6 tuples representing multiple points and calculate the distance for each point.
# - Create a function that takes a list of tuples and returns the point that is farthest from the origin.
# - Print the result to the console.

# b) TODO: Create a phonebook application
...
# - Write a function that asks for a user input on whether the user wants to add, remove, or update a phone number.
