...
- We can use debugging tools that are built into most IDEs
- We can also use debugging tools that are built into most IDEs
...
- We can use logging to track the execution of a program
- It is a more structured way to log errors and other issues
- We can use the `logging` module to log errors and other issues
