...
def _(margin_exa, mo, np, show_result):
    ...
    if margin_exa is None:
        ...
        _ok = False
        _msg = "Wrong: check the rule: the margin is the price minus 3.50."
...
def _(mo):
    mo.accordion(
        {
            "Hint 1 (a nudge)": "Subtract the courier cost from the whole array in one go, exactly like the worked example, with no loop or indexing.",
