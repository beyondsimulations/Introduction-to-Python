...
[Task:]{.task} Create a plot of your own for the temperature anomaly data.
...
- React.js is also used for these slides!

## Streamlit for Dashboards

- It is a rather new and popular library
- It is very easy to use and customizable
- Has some drawbacks on the performance side

## NiceGUI for Dashboards

- Also a relatively new library
- It is very easy to use and customizable
- Has a very Pythonic API

# [Creating GUIs with PySide6]{.flow} {.title}

## PySide6 for GUIs

- It is a mature library
