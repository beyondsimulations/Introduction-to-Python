...
::: {.callout-note}
**Next episode** starts with **Checkpoint 4**: 40 minutes, AI allowed, everything from Episodes 6–7. Then the investor opens a data room, and Kevin lets an AI write his pandas: the arrays get column names, and eighty orders become a table you can query.
:::
