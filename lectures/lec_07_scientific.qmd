...
# Your code here
assert sum(tensor) == 200

# TODO: Access the shape of the tensor using the property tensor.shape
# TODO: Print the dtype of the tensor using the method tensor.dtype
# TODO: Print the size of the tensor using the method tensor.size
```
...
[Task]{.task}: Analyze prices using broadcasting:

```{python}
#| eval: false

# Prices for 3 products
sales = np.array([3, 2, 5])

# TODO: Apply a 10% discount to all products using broadcasting
