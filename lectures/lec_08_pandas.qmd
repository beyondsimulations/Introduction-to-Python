...
Currently, [Zed](https://www.zed.dev/) is my favorite one. But this might change in the future, as there is a lot of competition in this space.
...
- If you need more prompts, create an account with [OpenRouter](https://openrouter.ai)
