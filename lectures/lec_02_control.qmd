...
::: {.callout-note}
**Next time — Episode 3** starts with **Checkpoint 1**: 40 minutes, no AI, everything from Episodes 1–2, so keep this notebook and the last one close. Then: Kevin has pasted the same receipt code **14 times**, and one small change now takes him an afternoon. We bring in **functions** to the rescue.
:::
