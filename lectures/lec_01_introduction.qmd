...
# [Artificial Intelligence]{.flow} {.title}
...
- Try to find help in lecture materials and books, the Python documentation, and online (e.g. Google, StackOverflow, ...)
...
[Task]{.task}: Open today's exercise notebook in your browser and run the following code:
...
[Task]{.task}: Assign the string `"Hello, World!"` to a variable called `message` and print the variable.
