...
- You are [allowed to use AI]{.highlight} (Claude, ChatGPT, Mistral ...)
...
- Download and install it from [https://zed.dev/](https://zed.dev/)
...
[Task]{.task}: Open the directory you created for the course and create a new file called `hello.py` with the following code:
...
[Task]{.task}: Create a new file called `message_world.py` file. Assign the string `"Hello, World!"` to a variable called `message` and print the variable.
