...
- No emojis anywhere (Tobi, 2026-09-09): verdicts are plain text, "Correct
  (Exercise N.M):", "Wrong (Exercise N.M):", "Not attempted (Exercise N.M)."
  No em or en dashes anywhere (Tobi, 2026-09-12): headings use a colon
  ("### Exercise 1.2 (core): title"), ranges a hyphen (5-10 min); hint
