...
You now have the basic knowledge to start working with [scientific computing]{.highlight}. Don't worry that we haven't applied Excel files yet, we will do so in the upcoming tutorial.
:::
