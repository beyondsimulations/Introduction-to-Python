...
subtitle: A short guide using uv
---
...
- `.gitignore` and `README.md` (only when the folder is new; a folder cloned from GitHub already has both)
...
This section needs **Zed**, which you install with the [AI-tools guide](ai-tools.qmd); come back to it afterwards. Instead of switching to the terminal every time, you can set up a **task** in Zed to run the currently open Python file with a single shortcut.
