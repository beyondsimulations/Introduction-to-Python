...
The green ✅ checks inside a checkpoint are provisional: they tell you you're on track. Final grading re-runs your submitted `.py` against a reference test suite on my side. Upload your download to the matching Moodle assignment **before the 40 minutes are up**; Moodle's clock decides what is on time, so start the download a couple of minutes early.
